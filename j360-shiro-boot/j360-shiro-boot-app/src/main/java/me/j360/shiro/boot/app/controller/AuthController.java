package me.j360.shiro.boot.app.controller;

import io.swagger.annotations.ApiOperation;
import lombok.extern.slf4j.Slf4j;
import me.j360.shiro.boot.UserSessionResponse;
...
public class AuthController {
    ...
    @ApiOperation(value = "访客授权接口", notes = "登录参数=cid(uuid)", code = 200, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @ApiOperation(value = "登录接口", notes = "登录参数=code(小程序code)&cid=uuid", code = 200, produces = MediaType.APPLICATION_JSON_VALUE)
